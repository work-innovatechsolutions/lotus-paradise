...
const ROOMS = [
  {
    ...
    location: "Latpanchar, North Bengal",
    description:
      "Our signature luxury suite features a private teak wood balcony overlooking the snow-capped Himalayan ranges, bespoke hand-carved furnishings, electric blanket warming, and attached marble bathroom with instant geyser.",
    amenities: [
  ...
  },
  {
    ...
    location: "Sittong, Darjeeling",
    description:
      "An intimate, romantic haven designed with warm ivory tones, colonial lamps, plush bedding, and floor-to-ceiling glass windows framing morning Himalayan mist.",
    amenities: [
      "Canopy Queen Bed",
