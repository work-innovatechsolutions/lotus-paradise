...
export const ROOMS: RoomData[] = [
  {
    ...
    description: "Comfortable ground floor deluxe room offering easy ground access, handcrafted teakwood decor, and serene garden surroundings. Complete all-inclusive Fooding & Lodging package with hot, delicious home-cooked Himalayan meals.",
    amenities: [
      "Fooding & Lodging Included",
      "Standard Package: ₹1,550/pax | Premium: ₹2,100/pax",
  ...
  },
  {
    ...
    size: "560 sq ft",
    location: "Latpanchar, North Bengal",
    description: "Spacious ground floor retreat specifically designed for family vacations and group retreats. Includes multi-bed configuration, generous family lounge, and all-inclusive Fooding & Lodging package.",
    amenities: [
      "Fooding & Lodging Included",
      "Standard Package: ₹1,550/pax | Premium: ₹2,100/pax",
  ...
  },
  {
    ...
    size: "390 sq ft",
    location: "Latpanchar, North Bengal",
    description: "Elevated first floor deluxe sanctuary featuring a private mountain-view balcony directly facing Mount Kanchenjunga. Complete Fooding & Lodging package with exquisite organic mountain meals.",
    amenities: [
      "Fooding & Lodging Included",
      "Standard Package: ₹1,650/pax | Premium: ₹2,250/pax",
  ...
  },
  {
    ...
    size: "620 sq ft",
    location: "Latpanchar, North Bengal",
    description: "The premier mountain-view family suite on the first floor. Expansive private balcony showcasing the Eastern Himalayan panorama, lavish space for 6 to 8 guests, and complete all-inclusive Fooding & Lodging.",
    amenities: [
      "Fooding & Lodging Included",
      "Standard Package: ₹1,650/pax | Premium: ₹2,250/pax",
  ...
  // Legacy aliases
  {
    id: "room-1",
    title: "Deluxe Room (Ground Floor)",
    slug: "deluxe-room-ground-floor-legacy",
    type: "Deluxe Room",
    floor: "Ground Floor",
    pricePerNight: 1550,
    standardPricePerPax: 1550,
    ...
    size: "360 sq ft",
    location: "Latpanchar, North Bengal",
    description: "Comfortable ground floor deluxe room offering easy ground access, handcrafted teakwood decor, and serene garden surroundings. Complete Fooding & Lodging package.",
    amenities: [
      "Fooding & Lodging Included",
  ...
  },
  {
    id: "room-2",
    title: "Deluxe Room (First Floor)",
    slug: "deluxe-room-first-floor-legacy",
    type: "Deluxe Room",
    floor: "First Floor",
    pricePerNight: 1650,
    standardPricePerPax: 1650,
    ...
    view: "Panoramic Kanchenjunga & Valley View",
    size: "390 sq ft",
    location: "Latpanchar, North Bengal",
    description: "First floor sanctuary with private balcony facing Mount Kanchenjunga. Complete Fooding & Lodging package.",
    amenities: [
      "Fooding & Lodging Included",
  ...
  },
  {
    id: "room-3",
    title: "Deluxe Family Room (Ground Floor)",
    slug: "deluxe-family-room-ground-floor-legacy",
    type: "Deluxe Family Room",
    floor: "Ground Floor",
    pricePerNight: 1550,
    standardPricePerPax: 1550,
    ...
    size: "560 sq ft",
    location: "Latpanchar, North Bengal",
    description: "Spacious ground floor retreat for families and groups. Complete Fooding & Lodging package.",
    amenities: [
      "Fooding & Lodging Included",
      "Standard: ₹1,550/pax | Premium: ₹2,100/pax",
      "Accommodation: 6 - 8 Pax",
